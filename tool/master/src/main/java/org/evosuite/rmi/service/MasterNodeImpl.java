...
public class MasterNodeImpl implements MasterNodeRemote, MasterNodeLocal {
    ...
    @Override
    public void evosuite_collectStatisticsNPETest(String clientRmiIdentifier, Chromosome<?> individual) {
        SearchStatistics.getInstance(clientRmiIdentifier).currentIndividualNPETest(individual);
    }
