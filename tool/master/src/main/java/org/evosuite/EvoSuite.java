...
public class EvoSuite {
    ...
    public static String fuzz_target_path;
    public static String fuzz_target_file;
    ...
    public Object parseCommandLine(String[] args) {
        ...
        try {
            ...
            if (line.hasOption("npetest")) {
                Properties.NPETEST_ON = true;
...
//            }
            ...
            if (line.hasOption("target_dir")) {
                Properties.TARGET_DIR = line.getOptionValue("target_dir");
            }
            ...
            // if (line.hasOption(Fuzzer.NAME)) {
            //     return Fuzzer.executeFuzz(options, javaOpts, line, fuzz_target_path, fuzz_target_file);
            // }
