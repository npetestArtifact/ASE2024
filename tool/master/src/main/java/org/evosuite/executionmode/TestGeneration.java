...
public class TestGeneration {
    ...
    public static Option[] getOptions() {
        return new Option[]{
                ...
                new Option("npetest", "use Dynamic Symbolic Execution to generate test suite")
    ...
    private static Strategy getChosenStrategy(List<String> javaOpts, CommandLine line) {
        ...
        } else if (line.hasOption("npetest")) {
            
            strategy = Strategy.NPETEST;
        }
        return strategy;
    }
    ...
    private static List<List<TestGenerationResult>> generateTests(Properties.Strategy strategy, String target,
        ...
        if (Properties.NPETEST_ON) {
            cmdLine.add("-Dnpetest=true");
        }

        if (Properties.TARGET_DIR != null) {
            cmdLine.add("-Dtarget_dir=" + Properties.TARGET_DIR);
        }
        ...
        switch (strategy) {
            ...
            case MAP_ELITES:
                ...
                break;
            // case PERFORMNPETEST: 
            //     cmdLine.add("-Dstrategy=performNPETest");
            //     break;
            case NPETEST:
                cmdLine.add("-Dstrategy=npetest");
                break;
        ...
        LoggingUtils.getEvoLogger().info("Start get Test Generation results");
