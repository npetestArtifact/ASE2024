...
public class CommandLineParameters {
    ...
    public static Options getCommandLineOptions() {
        ...
        Option npetest = new Option("npetest", false, "Allows Evosuite to perform NPETest");

        Option target_dir = new Option("target_dir", true,
                "path of the project");
        ...
        options.addOption(npetest);
        options.addOption(target_dir);
