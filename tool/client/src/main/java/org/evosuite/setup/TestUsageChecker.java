...
public class TestUsageChecker {
    ...
    public static boolean canUse(java.lang.reflect.Type t) {
        ...
        //  LoggingUtils.getEvoLogger().info("REFLECTED?" + t.toString());
            ...
            for (java.lang.reflect.Type parameterType : pt.getActualTypeArguments()) {
                ...
                //  LoggingUtils.getEvoLogger().info("TYPED...");
                    return false;
                }
            }

            
        //  LoggingUtils.getEvoLogger().info("OWNER TYPE...");
    ...
    //  LoggingUtils.getEvoLogger().info("STARTS CLASS CHECING");
        ...
        if (!Properties.USE_DEPRECATED) {
            try {
                if (c.isAnnotationPresent(Deprecated.class)) {
                    ...
                    //  LoggingUtils.getEvoLogger().info("DEPRECATED IN CLASS");
                        return false;
                    }
                }
            ...
            //  LoggingUtils.getEvoLogger().info("TRY CATC?");
                return false;
            }
        }

        if (c.isAnonymousClass()) {
        //  LoggingUtils.getEvoLogger().info("Annonymous?");
            return false;
        }

        if (isClassIncludedInPackage(c.getName(), Java9InvisiblePackage.instance.getClassesToBeIgnored())) {
        //  LoggingUtils.getEvoLogger().info("CLASS INCLUDED??");
            return false;
        }
        ...
        if (c.getEnclosingClass() != null) {
            ...
            //  LoggingUtils.getEvoLogger().info("ENCLOSING?");
                return false;
            }
        }
        ...
        if (c.getDeclaringClass() != null) {
            ...
            //  LoggingUtils.getEvoLogger().info("DECLARING CLASS?");
                return false;
            }
        }
        ...
        if (!c.isArray() && !c.isPrimitive() && !Properties.CLASS_PREFIX.isEmpty()
                && !c.getName().contains(".")) {
                //  LoggingUtils.getEvoLogger().info("PRIFIX??");
            return false;
        }
        ...
        //  LoggingUtils.getEvoLogger().info("Annonymous? in CLASS");
            return false;
        }
    ...
    //  LoggingUtils.getEvoLogger().info("PASSING");
        return false;
    }
    ...
    public static boolean npeTargets(Method m) {
        if (Properties.NPETEST_ON && ClassInfo.getInstance().isTargetMethod(m.toString())) {
            return true;            
        }
    ...
    public static boolean canUse(Method m, Class<?> ownerClass) {
        ...
        // If it is the NPE-likley methods we are interested in, we use the methods. 
        
        if (Properties.NPETEST_ON && ClassInfo.getInstance().isTargetMethod(m)) {
            return true;            
        }
