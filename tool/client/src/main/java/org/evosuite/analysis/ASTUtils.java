...
public class ASTUtils {
  ...
  public static void printSelectedEle (CtElement element) {
      ...
      try {
          ...
          LoggingUtils.getEvoLogger().info(s + ", " + element.getClass().getSimpleName() + ", " + element.toString());
      } catch (NullPointerException ex) {
          LoggingUtils.getEvoLogger().error("Unknown Element");
      }
  }

  public static void printAllEle (CtElement targetClass) {
    //Find the level in the Syntax Tree of the element
    int n = 0;
