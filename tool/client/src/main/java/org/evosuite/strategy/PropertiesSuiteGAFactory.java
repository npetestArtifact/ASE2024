...
public class PropertiesSuiteGAFactory
    ...
    protected ChromosomeFactory<TestSuiteChromosome> getChromosomeFactory() {
        switch (Properties.STRATEGY) {
            ...
            case MOSUITE:
                logger.info("Using MOSUITE chromosome factory");
                return new TestSuiteChromosomeFactory(new RandomLengthTestFactory());

            case NPETEST:
                logger.info("Using NPETEST chromosome factory");
                return new TestSuiteChromosomeFactory(new GuidedRandomLengthTestFactory());
