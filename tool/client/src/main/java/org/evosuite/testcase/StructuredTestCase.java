...
public class StructuredTestCase extends DefaultTestCase {
    ...
    public DefaultTestCase clone() {
        ...
        copy.setMUT(currentMUT);
        copy.setTriggeredNPE(triggeredNPE);

        return copy;
    }


    private transient String currentMUT;
    private transient int triggeredNPE;
    ...
    @Override
    public void setMUT(String methodKey) {
        currentMUT = methodKey;
    }
