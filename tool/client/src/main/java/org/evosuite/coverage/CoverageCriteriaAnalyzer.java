...
public class CoverageCriteriaAnalyzer {
    ...
    public static void reportCoverage(TestSuiteChromosome testSuite, Properties.Criterion criterion) {
        ...
        LoggingUtils.getEvoLogger().info("Covered Goals," + covered + "," + goals.size());
    }
