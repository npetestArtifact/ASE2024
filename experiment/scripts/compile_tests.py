...
class Command:
    def __init__(self, tool, result_base, benchmark_group, benchmark_name, experiment_id):
        ...
        compile_cmd = 'python3 /container_scripts/compile.py'
    ...
    def __repr__(self):
        return f'JavacCMD_{self.result_base_name}_{self.experiment_id[0:4]}[subject={self.benchmark_group}:{self.benchmark_name}]'
